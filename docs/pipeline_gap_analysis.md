...
| **高** | ~~补全 VL vernier zone（L37, L45）~~ | 修复已知遗漏 | 低 | **已完成** (2026-08-29) |
| **高** | 自动策略路由优化 (VH=adimab_frequency, VL=current) | 回测数据驱动 | 低 | **已完成** (2026-08-29) |
...
| **低** | 负面案例回测 | 量化假阳性/假阴性率 | 中 | **已完成** (31 pairs, 9 strategies) |
